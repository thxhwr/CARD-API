...
// 바로 $pdo 사용
$stmt = $pdo->query('SELECT FROM_UNIXTIME(AT_EXPIRES_IN / 1000) AS expires_at, AT_ACCESS_TOKEN FROM API_ACCESS_TOKEN WHERE AT_STATUS = "SUCCESS" ORDER BY AT_TIME_STAMP DESC LIMIT 1;');
